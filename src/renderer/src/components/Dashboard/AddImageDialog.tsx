          ...
          <div className="grid gap-4 py-4">
            <Tabs defaultValue="url">
              ...
              <TabsContent value="url">
                <Card>
                  <CardHeader>
                    <CardDescription>Pegue la URL de la imagen.</CardDescription>
                  </CardHeader>
              ...
              <TabsContent value="local">
                <Card>
                  <CardHeader>
                    <CardDescription>Seleccione la imagen de su equipo.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <div className="space-y-1">
            ...
            {showSuccessAlert && (
              <Alert>
                ...
                <AlertDescription>La imagen se guardó correctamente.</AlertDescription>
              </Alert>
            )}
            {showErrorAlert && (
