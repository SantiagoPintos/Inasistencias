    ...
    <div className="w-[85%] h-[85%]">
      ...
      <Dialog open={showConfirmation}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>¿Está seguro de que desea eliminar la imagen?</DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" onClick={handleCancelation}>
              Cancelar
            </Button>
      ...
      {error && (
        <Alert variant="destructive">
          ...
          <AlertDescription>Ha ocurrido un error al eliminar la imagen.</AlertDescription>
        </Alert>
      )}
    </div>
  )
